...
if st.session_state.lcoh_results:
    ...
    **Breakdown:**  
    ...
    # SECTION 2–5: Gated Access

    # Stripe subscription block
    st.markdown("### 🔐 Want to unlock full features?")
    st.markdown("[🔓 Subscribe for $9.99/month](https://buy.stripe.com/00geXhgI85Yn5uUbII)")
    ...
    if access == "paid":
        ...
        st.warning("🚫 Subscribe to unlock incentives, financials, and visualization tools.")
